...
; set bit 6 of wPikachuStatusFlags if any Pikachu with Surf is in party
; set bit 7 of wPikachuStatusFlags if starter Pikachu is in party (with or without Surf)
; also performs a bankswitch to IsStarterPikachuAliveInOurParty
	ld a, [wPikachuStatusFlags]
	and $3f
	ld [wPikachuStatusFlags], a
	ld hl, wPartyMon1
	ld c, PARTY_LENGTH
	ld b, SURF
.loop
